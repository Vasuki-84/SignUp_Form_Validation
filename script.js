document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", (error) => {
    ...
    document
      ...
      .forEach((clear) => (clear.textContent = ""));
    ...
    if (password.value === "" || confirmPassword.value === "") {
      ...
      document.getElementById("confirmPasswordError").style.color = "rgba(90, 248, 90, 0.7)";
      document.getElementById("confirmPasswordError").textContent =
        "Passwords match ✅";
    }
    ...
    if(!termsCheckbox.checked) {
         document.getElementById("checkBoxError").style.color =
        "red";
        document.getElementById("checkBoxError").textContent="You must select checkBox before submitting"
